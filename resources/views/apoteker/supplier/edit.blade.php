    ...
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                ...
                <p class="text-muted">Update informasi supplier</p>
            </div>
...
<div class="row">
    <div class="col-md-8">
        <div class="card-dashboard">
            <form action="{{ route('apoteker.supplier.update', $supplier->id_supplier) }}" method="POST">
                @csrf
                @method('PUT')
                
                <div class="mb-3">
                    <label for="nama_supplier" class="form-label">Nama Supplier <span class="text-danger">*</span></label>
                    <input type="text" class="form-control @error('nama_supplier') is-invalid @enderror" id="nama_supplier" name="nama_supplier" value="{{ old('nama_supplier', $supplier->nama_supplier) }}" required autofocus>
                    @error('nama_supplier')
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('no_telp_supplier') is-invalid @enderror" id="no_telp_supplier" name="no_telp_supplier" value="{{ old('no_telp_supplier', $supplier->no_telp_supplier) }}" required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="email" class="form-control @error('email_supplier') is-invalid @enderror" id="email_supplier" name="email_supplier" value="{{ old('email_supplier', $supplier->email_supplier) }}">
                ...
                <div class="mb-4">
                    ...
                    <textarea class="form-control @error('alamat_supplier') is-invalid @enderror" id="alamat_supplier" name="alamat_supplier" rows="4" required>{{ old('alamat_supplier', $supplier->alamat_supplier) }}</textarea>
