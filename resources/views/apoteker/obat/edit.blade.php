    ...
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                ...
                <p class="text-muted">Update informasi obat</p>
            </div>
...
<form action="{{ route('apoteker.obat.update', $obat->id_obat) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="row">
        <div class="col-md-8">
            <div class="card-dashboard">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('jenis_obat') is-invalid @enderror" id="jenis_obat" name="jenis_obat" required>
                            ...
                            <option value="Tetes" {{ old('jenis_obat', $obat->jenis_obat) == 'Tetes' ? 'selected' : '' }}>Tetes</option>
                            <option value="Alat Kesehatan" {{ old('jenis_obat', $obat->jenis_obat) == 'Alat Kesehatan' ? 'selected' : '' }}>Alat Kesehatan</option>
                        </select>
                        @error('jenis_obat')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('deskripsi_obat') is-invalid @enderror" id="deskripsi_obat" name="deskripsi_obat" rows="3">{{ old('deskripsi_obat', $obat->deskripsi_obat) }}</textarea>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control @error('harga_obat') is-invalid @enderror" id="harga_obat" name="harga_obat" value="{{ old('harga_obat', $obat->harga_obat) }}" min="0" required>
                        </div>
                        @error('harga_obat')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('stok_obat') is-invalid @enderror" id="stok_obat" name="stok_obat" value="{{ old('stok_obat', $obat->stok_obat) }}" min="0" required>
                        @error('stok_obat')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="date" class="form-control @error('tanggal_kadaluarsa') is-invalid @enderror" id="tanggal_kadaluarsa" name="tanggal_kadaluarsa" value="{{ old('tanggal_kadaluarsa', $obat->tanggal_kadaluarsa) }}">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('id_kategori') is-invalid @enderror" id="id_kategori" name="id_kategori">
                            ...
                            <option value="{{ $kategori->id_kategori }}" {{ old('id_kategori', $obat->id_kategori) == $kategori->id_kategori ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('id_supplier') is-invalid @enderror" id="id_supplier" name="id_supplier">
                            ...
                            <option value="{{ $supplier->id_supplier }}" {{ old('id_supplier', $obat->id_supplier) == $supplier->id_supplier ? 'selected' : '' }}>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('no_batch') is-invalid @enderror" id="no_batch" name="no_batch" value="{{ old('no_batch', $obat->no_batch) }}">
                    @error('no_batch')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
        ...
        <div class="col-md-4">
            <div class="card-dashboard">
                ...
                <div class="mb-3">
                    <label for="gambar_obat" class="form-label">Upload Gambar Baru</label>
