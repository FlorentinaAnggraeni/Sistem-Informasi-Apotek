    ...
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                ...
                <p class="text-muted">Update informasi kategori</p>
            </div>
...
<div class="row">
    <div class="col-md-6">
        <div class="card-dashboard">
            <form action="{{ route('apoteker.kategori.update', $kategori->id_kategori) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-4">
                    ...
                    <textarea class="form-control @error('deskripsi_kategori') is-invalid @enderror" id="deskripsi_kategori" name="deskripsi_kategori" rows="4">{{ old('deskripsi_kategori', $kategori->deskripsi_kategori) }}</textarea>
