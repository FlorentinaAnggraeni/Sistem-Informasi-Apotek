                        ...
                        <div class="card-body py-2">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-2 text-center">
                                    <small class="text-muted">{{ $item->jumlah }} x Rp {{ number_format($item->obat->harga_obat, 0, ',', '.') }}</small>
                                </div>
                                <div class="col-md-3 text-end">
                                    <strong class="text-primary">Rp {{ number_format($item->jumlah * $item->obat->harga_obat, 0, ',', '.') }}</strong>
                                </div>
                            </div>
                        </div>
                    </div>
