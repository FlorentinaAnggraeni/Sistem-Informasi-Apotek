...
<head>
    ...
    <style>
        * {
        ...
        .menu-card.orange .menu-card-icon {
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="menu-cards-grid">
            <a href="{{ route('apoteker.kelola-obat') }}" class="menu-card orange">
            ...
            <a href="{{ route('apoteker.transaksi') }}" class="menu-card purple">
                <div class="menu-card-icon">
            ...
            <a href="{{ route('apoteker.pesanan-masuk') }}" class="menu-card blue">
                <div class="menu-card-icon">
