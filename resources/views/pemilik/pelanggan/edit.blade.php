...
<div class="row mb-4">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h2 class="fw-bold mb-1">Edit Pelanggan</h2>
                <p class="text-muted">Ubah informasi pelanggan di bawah</p>
            </div>
...
<div class="row">
    <div class="col-lg-8">
        <div class="card-dashboard">
            <form action="{{ route('pemilik.pelanggan.update', $pelanggan) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" 
                               name="name" value="{{ old('name', $pelanggan->user->name) }}" required>
                        @error('name')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="email" class="form-control @error('email') is-invalid @enderror" 
                               name="email" value="{{ old('email', $pelanggan->user->email) }}" required>
                        @error('email')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('no_telp_pelanggan') is-invalid @enderror" 
                               name="no_telp_pelanggan" value="{{ old('no_telp_pelanggan', $pelanggan->no_telp_pelanggan) }}" required>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control @error('tanggal_lahir') is-invalid @enderror" 
                               name="tanggal_lahir" value="{{ old('tanggal_lahir', $pelanggan->tanggal_lahir) }}">
                        @error('tanggal_lahir')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('alamat_pelanggan') is-invalid @enderror" 
                              name="alamat_pelanggan" rows="3" placeholder="Alamat lengkap pelanggan" required>{{ old('alamat_pelanggan', $pelanggan->alamat_pelanggan) }}</textarea>
