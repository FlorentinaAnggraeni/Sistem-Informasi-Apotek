...
<div class="row mb-4">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h2 class="fw-bold mb-1">Edit Karyawan</h2>
                <p class="text-muted">Ubah informasi karyawan di bawah</p>
            </div>
...
<div class="row">
    <div class="col-lg-8">
        <div class="card-dashboard">
            <form action="{{ route('pemilik.karyawan.update', $karyawan) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('username') is-invalid @enderror" 
                               name="username" value="{{ old('username', $karyawan->user->username) }}" required>
                        @error('username')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="email" class="form-control @error('email') is-invalid @enderror" 
                               name="email" value="{{ old('email', $karyawan->user->email) }}" required>
                        @error('email')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mb-4">
                    ...
                    <select class="form-select @error('role') is-invalid @enderror" name="role" required>
                        ...
                        <option value="apoteker" {{ old('role', $karyawan->user->role) == 'apoteker' ? 'selected' : '' }}>Apoteker</option>
                    </select>
                    @error('role')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('nama_karyawan') is-invalid @enderror" 
                               name="nama_karyawan" value="{{ old('nama_karyawan', $karyawan->nama_karyawan) }}" required>
                        @error('nama_karyawan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('jabatan') is-invalid @enderror" 
                               name="jabatan" value="{{ old('jabatan', $karyawan->jabatan) }}" placeholder="Contoh: Staff Gudang" required>
                        @error('jabatan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('no_telp_karyawan') is-invalid @enderror" 
                               name="no_telp_karyawan" value="{{ old('no_telp_karyawan', $karyawan->no_telp_karyawan) }}" 
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control @error('tanggal_bergabung') is-invalid @enderror" 
                               name="tanggal_bergabung" value="{{ old('tanggal_bergabung', $karyawan->tanggal_bergabung?->format('Y-m-d')) }}">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('gaji') is-invalid @enderror" 
                               name="gaji" value="{{ old('gaji', $karyawan->gaji) }}" placeholder="0" min="0">
                        @error('gaji')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('alamat_karyawan') is-invalid @enderror" 
                              name="alamat_karyawan" rows="3" placeholder="Alamat lengkap karyawan">{{ old('alamat_karyawan', $karyawan->alamat_karyawan) }}</textarea>
    ...
    <div class="col-lg-4">
        <div class="card-dashboard bg-light">
            ...
            <ul class="small text-muted mb-0" style="list-style: none; padding-left: 0;">
                <li class="mb-2"><i class="fas fa-check-circle text-success"></i> Ubah data yang perlu disesuaikan</li>
                <li class="mb-2"><i class="fas fa-check-circle text-success"></i> Password boleh dikosongkan jika tidak ingin mengubah</li>
                <li class="mb-2"><i class="fas fa-check-circle text-success"></i> Apoteker memiliki akses lebih</li>
                <li class="mb-2"><i class="fas fa-check-circle text-success"></i> Perubahan akan tersimpan otomatis</li>
            </ul>
        </div>
    </div>
</div>
